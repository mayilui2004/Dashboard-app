...
with tab2:
    ...
    # Fixed: Using darker, more visible colors for highlighting
...
with tab3:
    ...
    # FIX: Use all available models instead of just selected_models
    ...
    **Key Features:**
    ...
    with col1:
        ...
        <div style='background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.07);'>
            <h4 style='color: #667eea;'>SHAP (SHapley Additive exPlanations)</h4>
            <ul style='line-height: 1.8;'>
                <li>Global feature importance analysis</li>
                <li>Based on cooperative game theory</li>
                <li>Identifies key predictive features</li>
    ...
    with col2:
        st.markdown("""
        <div style='background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.07);'>
            <h4 style='color: #f5576c;'>LIME (Local Interpretable Model-agnostic Explanations)</h4>
            <ul style='line-height: 1.8;'>
                <li>Local explanation for individual predictions</li>
                <li>Human-interpretable explanations</li>
                <li>Feature impact visualization</li>
                <li>Trust and transparency enhancement</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div style='background: white; padding: 15px; border-radius: 10px; border-left: 4px solid #4facfe;'>
            <h4 style='color: #4facfe; margin-top: 0;'>Explainability</h4>
            <p>SHAP Library</p>
            <p>LIME Library</p>
            <p>Pandas</p>
